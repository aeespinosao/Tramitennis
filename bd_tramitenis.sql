...
INSERT INTO `horario`(`fecha_inicio`, `hora`, `cancha`, `fecha_fin`) VALUES (date('2017-4-14'),time('6:00'),'2',
  date('2017-5-30')),(date('2017-4-14'),time('7:00'),'2',date('2017-5-30')),(date('2017-4-14'),time('8:00'),'2',
  date('2017-5-30')),(date('2017-4-14'),time('9:00'),'2',date('2017-5-30')),(date('2017-4-14'),time('10:00'),'2',
  date('2017-5-30')),(date('2017-4-14'),time('11:00'),'2',date('2017-5-30')),(date('2017-4-14'),time('12:00'),'2',
  date('2017-5-30')),(date('2017-4-14'),time('13:00'),'2',date('2017-5-30')),(date('2017-4-14'),time('14:00'),'2',
  date('2017-5-30')),(date('2017-4-14'),time('15:00'),'2',date('2017-5-30')),(date('2017-4-14'),time('16:00'),'2',
